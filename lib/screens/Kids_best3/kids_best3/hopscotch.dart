...
class Hopscotch extends StatefulWidget {
  final String name = 'Hopscotch';
  final String imageUrl = 'images/kid3.jpg';
  final double price = 499.0;
  final String brand = 'Hopscotch';
  ...
  const Hopscotch({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Hopscotch> createState() => _HopscotchScreenState();
}

class _HopscotchScreenState extends State<Hopscotch> {
