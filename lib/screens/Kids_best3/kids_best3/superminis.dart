...
import '../../men_best2/louis_color.dart';

class Superminis extends StatefulWidget {
  final String name = 'Superminis';
  final String imageUrl = 'images/kid5.jpg';
  final double price = 499.0;
  final String brand = 'Superminis';
  ...
  const Superminis({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Superminis> createState() => _SuperminisScreenState();
}

class _SuperminisScreenState extends State<Superminis> {
