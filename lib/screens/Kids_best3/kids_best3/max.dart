...
class Max extends StatefulWidget {
  ...
  final String imageUrl = 'images/kid2.jpg';
  final double price = 499.0;
  final String brand = 'Max';
  ...
  const Max({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Max> createState() => _MaxScreenState();
}

class _MaxScreenState extends State<Max> {
