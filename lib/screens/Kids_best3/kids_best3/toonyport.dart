...
class Toonyport extends StatefulWidget {
  final String name = 'Toonyport';
  final String imageUrl = 'images/kid4.jpg';
  final double price = 499.0;
  final String brand = 'Toonyport';
  ...
  const Toonyport({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Toonyport> createState() => _ToonyporteScreenState();
}

class _ToonyporteScreenState extends State<Toonyport> {
