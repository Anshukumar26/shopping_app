...
class Babygo extends StatefulWidget {
  final String name = 'Baby Go';
  final String imageUrl = 'images/kid1.jpg';
  final double price = 499.0;
  final String brand = 'Baby Go';
  ...
  const Babygo({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Babygo> createState() => _BabygoScreenState();
}

class _BabygoScreenState extends State<Babygo> {
