...
class Kidsville extends StatefulWidget {
  final String name = 'Kidsville';
  final String imageUrl = 'images/kid6.jpg';
  final double price = 499.0;
  final String brand = 'Kidsville';
  ...
  const Kidsville({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Kidsville> createState() => _KidsvilleScreenState();
}

class _KidsvilleScreenState extends State<Kidsville> {
