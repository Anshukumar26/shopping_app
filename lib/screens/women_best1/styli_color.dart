...
import 'package:shopping_app/screens/women_best1/styli.dart';
...
class _GradientGeneratorState extends State<GradientGenerator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Styli Pattern Picker', style: TextStyle(color: Colors.white)),
                            ...
                            GestureDetector(
                              onTap: () async {
                                final Color? picked = await showDialog(
                                  context: context,
                                  builder: (context) => ColorPickerDialog(initialColor: selectedColors[i]),
                                );
                                if (picked != null) {
                                  setState(() {
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: _imagePath == null
                              ? const Center(child: Icon(Icons.upload, size: 40, color: Colors.grey))
