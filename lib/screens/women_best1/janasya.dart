...
class Janasya extends StatefulWidget {
  final String name = 'Janasya';
  final String imageUrl = 'images/women2.jpg';
  final double price = 499.0;
  final String brand = 'Janasya';
  final Gradient? selectedGradient;
  final String? uploadedImagePath;

  const Janasya({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Janasya> createState() => _VeroModaScreenState();
}

class _VeroModaScreenState extends State<Janasya> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Gradient and image customization
                  Row(
                    children: [
                      GestureDetector(
                        onTap: () {
