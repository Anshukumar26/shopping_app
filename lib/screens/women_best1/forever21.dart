...
class Forever21 extends StatefulWidget {
  final String name = 'Forever 21';
  final String imageUrl = 'images/women5.jpg';
  final double price = 499.0;
  final String brand = 'Forever 21';
  final Gradient? selectedGradient;
  final String? uploadedImagePath;

  const Forever21({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Forever21> createState() => _VeroModaScreenState();
}

class _VeroModaScreenState extends State<Forever21> {
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: widget.uploadedImagePath != null
                              ? Image.file(File(widget.uploadedImagePath!), fit: BoxFit.cover)
