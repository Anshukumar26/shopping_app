...
class Facescanada extends StatefulWidget {
  final String name = 'Facescanada';
  final String imageUrl = 'images/b2.jpg';
  final double price = 499.0;
  final String brand = 'Facescanda';
  ...
  const Facescanada({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Facescanada> createState() => _FacescandaScreenState();
}

class _FacescandaScreenState extends State<Facescanada> {
