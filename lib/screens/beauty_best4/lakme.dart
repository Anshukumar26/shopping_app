...
class Lakme extends StatefulWidget {
  final String name = 'Lakme';
  final String imageUrl = 'images/b6.jpg';
  final double price = 499.0;
  final String brand = 'Lakme';
  ...
  const Lakme({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Lakme> createState() => _LakmeoScreenState();
}

class _LakmeoScreenState extends State<Lakme> {
