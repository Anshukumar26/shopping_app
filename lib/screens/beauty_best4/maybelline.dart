...
class Maybelline extends StatefulWidget {
  final String name = 'Maybelline';
  final String imageUrl = 'images/b3.jpg';
  ...
  const Maybelline({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Maybelline> createState() => _MaybellineScreenState();
}

class _MaybellineScreenState extends State<Maybelline> {
