...
class Swiss extends StatefulWidget {
  final String name = 'Swiss Beauty';
  final String imageUrl = 'images/b1.jpg';
  final double price = 499.0;
  final String brand = 'Swiss Beauty';
  ...
  const Swiss({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Swiss> createState() => _SwissScreenState();
}

class _SwissScreenState extends State<Swiss> {
