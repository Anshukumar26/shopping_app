...
class Sugar extends StatefulWidget {
  ...
  final String imageUrl = 'images/b5.jpg';
  ...
  const Sugar({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Sugar> createState() => _SugarScreenState();
}

class _SugarScreenState extends State<Sugar> {
