...
class UsPolo extends StatefulWidget {
  final String name = 'Janasya';
  final String imageUrl = 'images/men6.jpg';
  ...
  const UsPolo({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<UsPolo> createState() => _UsPoloScreenState();
}

class _UsPoloScreenState extends State<UsPolo> {
