...
class Turtle extends StatefulWidget {
  final String name = 'Turtle';
  final String imageUrl = 'images/men9.jpg';
  final double price = 499.0;
  final String brand = 'Turtle';
  ...
  const Turtle({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Turtle> createState() => _TurtleScreenState();
}

class _TurtleScreenState extends State<Turtle> {
