...
class SymbolPremium extends StatefulWidget {
  final String name = 'Symbol Premium';
  final String imageUrl = 'images/men7.jpg';
  final double price = 499.0;
  final String brand = ' Symbol Premium';
  ...
  const SymbolPremium({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<SymbolPremium> createState() => _SymbolPremiumScreenState();
}

class _SymbolPremiumScreenState extends State<SymbolPremium> {
