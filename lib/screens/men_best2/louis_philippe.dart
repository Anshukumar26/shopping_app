...
class LouisPhilippe extends StatefulWidget {
  final String name = 'Louis Philippe';
  final String imageUrl = 'images/men8.jpg';
  ...
  const LouisPhilippe({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<LouisPhilippe> createState() => _LouisPhilippeScreenState();
}

class _LouisPhilippeScreenState extends State<LouisPhilippe> {
