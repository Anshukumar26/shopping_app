...
class Puma extends StatefulWidget {
  final String name = 'Puma';
  final String imageUrl = 'images/men5.jpg';
  final double price = 499.0;
  final String brand = 'Puma';
  ...
  const Puma({super.key, this.selectedGradient, this.uploadedImagePath});

  @override
  State<Puma> createState() => _PumaScreenState();
}

class _PumaScreenState extends State<Puma> {
